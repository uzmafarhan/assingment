...
console.log("Enquality test :", ("Hmmad ali" as string) === "Hmmad ali");

console.log("Inquality test :", ("Hmmad ali" as string) === "Imran khan"); 
...
console.log("Inquality test", (10 as number) !== 9); //Inquality
